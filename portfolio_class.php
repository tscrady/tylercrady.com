...
class portfolio{
    ...
    */
    ...
    function create_new_portfolio($data){
        ...
        //Portfolio query
        $query  = "insert into portfolio (title, body, project_type, date, technology) values (:title,:body,:project_type,'$date', :technology)";
    ...
    function edit_portfolio($data){
        ...
        //Portfolio query
        $query  = "update portfolio set title=:title, body=:body,  project_type=:project_type, date='$date', technology=:technology where id='$portfolio_id'";
